...
const NewArticleDesktop = ({ setCreateArticle }: Props) => {
  ...
  return (
    <div className="pb-10  sm:px-2 sm:pb-16   w-full  sm:w-auto  overflow-y-auto">
      <div className="w-full flex  sm:rounded-lg">
        <div className="px-4 py-5 relative  w-full">
...
export default NewArticleDesktop;
